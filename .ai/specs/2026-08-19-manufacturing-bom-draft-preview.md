...
- 2026-09-05: Added the restricted MVP-D same-unit exact-decimal propagation profile while retaining the Catalog-resolver gate for general P1.4b behavior.
