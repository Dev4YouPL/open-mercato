...
| P1.3a | Establish exact Catalog/Sales quantity normalization | `catalog` | Existing Catalog/Sales UoM contract and exact decimal utilities | Specification-level readiness remediation complete; implementation after parent-roadmap merge gate | Parent-roadmap repository acceptance/merge | One Catalog-owned resolver and deterministic quantity snapshots |
...
- 2026-08-28: Recorded P1.3a specification-level readiness completion after exact-factor, atomic-save, productless-Sales, DI-contract and scope remediation; implementation still waits for the parent-roadmap merge gate.
