...
|---|---|---|
| First parallel increment | P1.0a bootstrap, P1.4a BOM authoring, P1.4b bounded preview, P1.5 routing draft CRUD, P1.6 work-centre boundary | Delivers the Manufacturing foundation, usable authoring and its independently bounded read view early; the Catalog public contract supplies quantity semantics and P1.6 blocks released resource contracts |
