  ...
  methods: {
    ...
    POST: {
      ...
      errors: [
        ...
        { status: 404, description: 'BOM not found.' },
        { status: 409, description: 'Stale expected-version token or cycle detected.', schema: bomConflictSchema },
        { status: 422, description: 'Invalid quantity/UoM evidence.', schema: bomDomainErrorSchema },
      ],
    },
  },
}
