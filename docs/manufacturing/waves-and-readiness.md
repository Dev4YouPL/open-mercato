...
| **P1.4a** | Direct-level reusable BOM draft authoring and integrity | [Full specification](../../.ai/specs/2026-08-19-manufacturing-bom-drafts.md); [spec task #5393](https://github.com/open-mercato/open-mercato/issues/5393) | P1.4 split and authoring boundary accepted by roadmap owner | Full aggregate/data/CRUD/API/UI/command/undo/concurrency design; customer/order/dates remain in P1.10; fresh-context review **PASS** | **No — P1.0a pending; Catalog contract gates only quantity-bearing BOM writes** | Accept upstream Manufacturing gates, then implement the reviewed direct-level authoring/integrity contract |
| **P1.4b** | Bounded read-only multi-level BOM draft preview | [Full specification](../../.ai/specs/2026-08-19-manufacturing-bom-draft-preview.md); [spec task #5405](https://github.com/open-mercato/open-mercato/issues/5405) | P1.4 split and preview boundary accepted by roadmap owner | Full explosion/API/UI/isolation/limit design; fresh-context review **PASS** | **No — P1.0a/P1.4a pending; Catalog contract gates exact quantity evaluation** | Accept upstream Manufacturing gates, then implement the reviewed occurrence-tree and bounded exact read contract |
...
| **P1.4d** | BOM business identity | [Spec task #5409](https://github.com/open-mercato/open-mercato/issues/5409) | Post-Wave 0 decision accepted | Code/name is distinct from product/variant and revision identity | **No — specification missing** | Decide whether a family code/name is necessary, then define ownership, uniqueness and compatibility |
| **P1.4e** | BOM history, change context and comments | [Spec task #5410](https://github.com/open-mercato/open-mercato/issues/5410) | Post-Wave 0 decision accepted | Reuse platform action-log/version-history and Notes patterns | **No — specification missing** | Define aggregate ownership, ACL and immutable-release behavior; this does not gate P1.7 |
