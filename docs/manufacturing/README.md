...
| P1.6 | Establish the work-centre extension boundary | [Full specification](../../.ai/specs/2026-08-19-manufacturing-work-centres.md); [spec task #5394](https://github.com/open-mercato/open-mercato/issues/5394) open | Design complete; readiness review pending | P1.0a | Run readiness review; Work Center owns optional many-Resource membership and snapshots, while capacity/calendars remain outside scope |
